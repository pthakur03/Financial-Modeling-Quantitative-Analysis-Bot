...
"""
Python implementation for the Renko + On-Balance Volume (OBV) backtesting strategy
    Current implementation most optimal in intraday trading.
